...
var Lab = require('lab'),
  Hapi = require('hapi'),
  Plugin = require('../../../lib/plugins/filipediasferreira');
...
describe('filipediasferreira', function() {
  ...
  it('Plugin registers routes', function(done) {
    ...
    expect(table[0].path).to.equal('/filipediasferreira');
